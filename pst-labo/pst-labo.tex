...
\def\PSTBun{\pst@BecBunsen}
\def\tropfen{\pst@goutte}
\def\PSTBunflamme{
...
(0.25,1.5)(0.35,1)(0.4,0.75)%
(0.35,0.5)(0.25,0)(0,0)}%
\pspolygon[linestyle=none,fillstyle=gradient,gradmidpoint=0,gradbegin=OrangePale,gradend=white]%
(-0.25,0)(0.25,0)(0,1)%
\endpsclip
}
...
\def\PSTflammeBlue{
\psclip{\psbezier[linestyle=none,fillstyle=gradient,gradmidpoint=0,%
gradbegin=green!40,gradend=blue!60]%
(-0.25,0)(-0.35,0.5)(-0.4,0.75)%
(-0.35,1)(-0.25,1.5)(0.5,2)%
(0.25,1.5)(0.35,1)(0.4,0.75)%
(0.35,0.5)(0.25,0)(0,0)}%
...
\def\pstZinc{\pst@Zinc}
\definecolor{Cu}{rgb}{.8,.7,.2}
\def\pstKupfer{{%
  \pscurve[unit=0.5,fillstyle=solid,fillcolor=Cu](0,0)(-0.25,0.25)(0,.5)(0.25,0.75)(0.5,0.5)(0.15,0.4)(0.,0)}}
...
\define@key[psset]{pst-labo}{tubePenche}{%
  \pst@cntg=#1\relax
  % tubePenche must be between -65 and 65 %% modified by Robin: von 65 auf 95
  \ifnum\pst@cntg<-95
    \typeout{Angle must be >=-95 and not `\the\pst@cntg'. Value -95 forced.}%
    \pst@cntg=95
  \fi%
  \ifnum\pst@cntg>95
    \typeout{Angle must be <=95 and not `\the\pst@cntg'. Value 95 forced.}%
